	  		...
	  		<div class="col-sm-12 col-xl-12">
	  			...
	  			<div class="card bd-0 shadow-base">
	  				<div class="d-md-flex justify-content-between pd-25">
	  					<div><h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1">Manage All Category</h6>
	  					</div>
						    ...
						    <tr>
						      ...
						      <td>{{ $cat->category_slug}}</td>
						        <td>
						      	...
						      	@else
						      	<span class="badge badge-warning">{{ $cat->parent->category_name}}</span>
