...
@section ('body')
 ...
 <div class="br-pagetitle">
        ...
        <div>
          <h4>Update color Information</h4>
	  		...
	  		<div class="col-sm-12 col-xl-12">
	  			...
	  			<div class="card bd-0 shadow-base">
	  				<div class="d-md-flex justify-content-between pd-25">
	  					<div><h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1">Update color Information</h6>
	  					</div>
	  				...
	  				<div class="pd-1-25 pd-r-15 pd-b-25">
	  					<form action="{{ route('color.update', $color->id) }}" method="POST" enctype="multipart/form-data">
	  						...
	  						<div class="form-group">
	  							<input type="submit" name="updatecolor" class="btn btn-primary" value="Save Change">
