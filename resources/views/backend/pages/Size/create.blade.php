	  		...
	  		<div class="col-sm-12 col-xl-12">
	  			...
	  			<div class="card bd-0 shadow-base">
	  				<div class="d-md-flex justify-content-between pd-25">
	  					<div><h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1">Create New Size</h6>
	  					</div>
	  				...
	  				<div class="pd-1-25 pd-r-15 pd-b-25">
	  					<form action="{{ route('size.store') }}" method="POST" enctype="multipart/form-data">
	  						...
	  						<div class="form-group">
	  							<input type="submit" name="addSize" class="btn btn-primary" value="Add New Size">
